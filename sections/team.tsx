    ...
    const ImageContainer = (
      <div className="relative mb-2">
        ...
        >
          ...
          />
          {member.linkedin && (
            <div className="absolute top-1 right-1 p-1 bg-white/10 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-sm">
              <img src="/linkedin.svg" alt="LinkedIn" className="w-2 h-2 md:w-3 md:h-3" />
            </div>
          )}
        </div>
